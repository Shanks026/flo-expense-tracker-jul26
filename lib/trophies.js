...
// Perfect Month / Categorizer / Comeback / Fresh Start are single binary
// trophies (one tier each, tier:1) — a plain pair of requires, not a
// tier-keyed map like Logger/Streak/Planner/Budget Keeper (nothing to key by).
...
export const FRESH_START_BADGE_ART = require('../assets/fresh_start/fresh_start.png');
export const FRESH_START_BADGE_ART_LOCKED = require('../assets/fresh_start/fresh_start-locked.png');

// Illustrated badge art for Frugal's ladder (assets/frugal/), keyed by the
// no-spend-days tier — same shape as LOGGER_BADGE_ART above.
export const FRUGAL_BADGE_ART = {
  5: require('../assets/frugal/5.png'),
  25: require('../assets/frugal/25.png'),
  100: require('../assets/frugal/100.png'),
};

export const FRUGAL_BADGE_ART_LOCKED = {
  5: require('../assets/frugal/5-locked.png'),
  25: require('../assets/frugal/25-locked.png'),
  100: require('../assets/frugal/100-locked.png'),
};
