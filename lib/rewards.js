...
export const RANK_FLAVOR = {
  ...
  bookkeeper: "Saver was instinct. This is discipline — you're keeping real records now.",
  steward: "You're not just logging anymore. You're minding it like it's worth minding.",
  strategist: "This isn't a habit now, it's a plan. You're thinking ahead.",
  treasurer: "Real trust, at this level — the kind of track record people build a plan around.",
  financier: "You've moved past managing money. Now you're growing it.",
  tycoon: 'Serious wealth, seriously tracked. Not many get here.',
  magnate: 'Your reach is wide now, and every rupee of it is accounted for.',
  money_master: 'The top. Total command over every rupee you have ever earned.',
};
